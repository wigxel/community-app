...
export function ProjectDetailsPopup(props: ProjectDetailsProps) {
  const { project } = props;
  ...
  return (
    <div className="mx-auto flex w-full max-w-4xl flex-col">
      ...
      <div className="relative flex max-h-[40vh] min-h-55 w-full shrink-0 items-center justify-center overflow-hidden">
        <MediaThumb
          item={active}
          alt={project.title}
